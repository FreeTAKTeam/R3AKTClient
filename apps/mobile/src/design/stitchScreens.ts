...
export const stitchScreens: StitchScreen[] = [
  createStitchScreen(
    ...
    "rch-side-navigation-menu",
    "b0b7630adcc641b289484ddbc3a59c69",
  ...
  createStitchScreen(
    ...
    "e3d3bb507e234d508f166e6ae9c45df9",
  ...
  createStitchScreen(
    ...
    "0e2cf48f55aa4a1495391eebdda4cd9f",
  ...
  createStitchScreen(
    ...
    "topic-registry-clean-header",
    "530e1677fcd6468daccc1075384d7106",
  ...
  createStitchScreen(
    ...
    "Chat - Clean Header",
    "chat-clean-header",
    "2d3c2ea5fcec499691a078dfc9246c36",
  ...
  createStitchScreen(
    ...
    "0f69b3128030426cb2381765049b4191",
  ...
  createStitchScreen(
    ...
    "missions-workspace-clean-header",
    "dbd5605c733f4c0cb8ced306d5f7b0b0",
  ...
  createStitchScreen(
    ...
    "e62cce5130224b6a9dbd0625dce7c764",
  ...
  createStitchScreen(
    ...
    "12f0130f884b4130a00a408e82b3c409",
  ...
  createStitchScreen(
    ...
    "5b857a91b02f45bdb787f19c9dbe2885",
  ...
  createStitchScreen(
    ...
    "checklists-clean-header-v2",
    "af001a983a554df4af471ba2fb0bfa2d",
  ...
  createStitchScreen(
    ...
    "85831ee54b2f41de9c4848c32e37f664",
  ...
  createStitchScreen(
    ...
    "task-detail-clean-header",
    "0d6df06555a24c089123b1af5d5d5f77",
...
export const stitchScreensBySlug = Object.fromEntries(
  stitchScreens.map((screen) => [screen.routeSlug, screen]),
) as Record<string, StitchScreen>;
